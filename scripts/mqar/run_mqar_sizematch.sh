...
run() {  # name  matrix  extra_args  models
  ...
  CUDA_VISIBLE_DEVICES=$GPU $PY scripts/mqar/run_mqar_associative_recall.py \
...
run "MB_14025"      "connectomes/flywire_mushroom_body/adjacency_unsigned.npz"  ""                  "hemibrain_seeded random_sparse"
run "OL_firstblock" "connectomes/flywire_optic_lobe_bpu/adjacency_unsigned.npz" "--max-neurons 14025" "hemibrain_seeded random_sparse"
run "OL_rand_s1"    "connectomes/ol_sub14025_s1/adjacency_unsigned.npz"         ""                  "hemibrain_seeded"
run "OL_rand_s2"    "connectomes/ol_sub14025_s2/adjacency_unsigned.npz"         ""                  "hemibrain_seeded"
