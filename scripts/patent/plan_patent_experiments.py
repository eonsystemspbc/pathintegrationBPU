    ...
    for task in (TASK_CX_POLAR_BUMP, TASK_MB_ASSOCIATIVE_LEARNING, TASK_OPTIC_FLOW, TASK_CX_LANDMARK_BUMP):
        ...
        commands.append(
            ExperimentCommand(
                ...
                command=(
                    "python",
                    "scripts/connectome/select_connectome.py",
                    "--task",
                    task,
                    "--json-output",
    ...
    commands.extend(
        [
            ...
            ExperimentCommand(
                ...
                command=(
                    "python",
                    "scripts/associative/run_mb_associative_learning.py",
                    "--matrix",
            ...
            ExperimentCommand(
                ...
                command=(
                    "python",
                    "scripts/transfer/run_cross_region_transfer.py",
                    "--mode",
                    "all",
                    "--pairs",
                    "all",
            ...
            ExperimentCommand(
                ...
                command=(
                    "python",
                    "scripts/flow/run_optic_flow_benchmark.py",
                    "--mode",
                    "all",
                    "--output-dir",
            ...
            ExperimentCommand(
                ...
                command=(
                    "python",
                    "scripts/benchmarks/run_low_power_proxy_benchmark.py",
                    "--graph-dir",
                    str(results / "cx_path_observed_5seed"),
                    "--graph-dir",
                    str(results / "optic_flow_5seed"),
            ...
            ExperimentCommand(
                ...
                command=(
                    "python",
                    "scripts/patent/make_patent_evidence_report.py",
                    "--results-root",
                    str(evidence),
                    "--output",
