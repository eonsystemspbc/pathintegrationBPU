...
run_config() {  # name  extra_args
  ...
  CUDA_VISIBLE_DEVICES=0 $PY scripts/associative/run_mb_associative_learning.py \
  ...
  CUDA_VISIBLE_DEVICES=1 $PY scripts/associative/run_mb_associative_learning.py \
