...
# reorg: scripts live in topic subdirs; expose all of them for cross-imports
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--matrix",
        type=Path,
        default=Path("connectomes/hemibrain_mushroom_body_plume/adjacency_unsigned.npz"),
        help="Prepared mushroom-body adjacency npz.",
    )
    parser.add_argument(
        "--pool-assignments",
        type=Path,
        default=Path("connectomes/hemibrain_mushroom_body_plume/pool_assignments.csv"),
