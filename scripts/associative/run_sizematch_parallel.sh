...
CUDA_VISIBLE_DEVICES=$GPU $PY scripts/mqar/run_mqar_associative_recall.py \
  --matrix connectomes/flywire_optic_lobe_bpu/adjacency_unsigned.npz --max-neurons 14025 \
...
CUDA_VISIBLE_DEVICES=$GPU $PY scripts/mqar/run_mqar_associative_recall.py \
  --matrix connectomes/ol_sub14025_s1/adjacency_unsigned.npz --models hemibrain_seeded $CFG \
  --output-dir $ROOT/OL_rand_s1 > $ROOT/OL_rand_s1.full.log 2>&1 &
P1=$!; sleep 20
CUDA_VISIBLE_DEVICES=$GPU $PY scripts/mqar/run_mqar_associative_recall.py \
  --matrix connectomes/ol_sub14025_s2/adjacency_unsigned.npz --models hemibrain_seeded $CFG \
