...
def main(argv=None) -> int:
    ...
    p.add_argument("--substrate", choices=("cx_full",), default="cx_full")
    ...
    p.add_argument("--train-batches", type=int, default=200,
                   help="gradient steps per epoch (backprop/hybrid). Lower = faster epochs; "
                        "total steps = epochs*train_batches. Reduced under a compute/time budget.")
