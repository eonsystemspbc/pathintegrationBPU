...
```json
{
  ...
  "output_dir": "/home/ec2-user/pathintegrationBPU/pathintegrationBPU/outputs/cx_path_observed_3seed",
  "device": "cuda",
  "seeds": [
    0,
    1,
...
path_cx_seeded        path hemibrain_cx                 True home_bearing_angular_error             False home_distance_rmse      0.479032     0.081575       15.706551       1.028769      3
```
